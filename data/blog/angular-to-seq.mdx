...
tags:
  ...
  - Angular
draft: false
summary: "Guide to sending Angular client-side logs to Seq using JSNLog and structured logging for better debugging and diagnostics."
tldr: "Use JSNLog in Angular, forward structured events to a backend Serilog sink, then query and correlate issues in Seq."
images:
